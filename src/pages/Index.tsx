  ...
  const news = [
    {
      ...
      description: 'С 20 по 25 декабря будет проведено плановое отключение горячей воды в связи с ремонтными работами на магистральном трубопроводе.',
      type: 'work'
    },
    {
      id: 2,
      date: '10 декабря 2025',
      title: 'Изменение тарифов с 1 января',
      description: 'С 1 января 2026 года вступают в силу новые тарифы на коммунальные услуги. Повышение составит 4.5% согласно постановлению правительства.',
      type: 'tariff'
    },
    {
      id: 3,
      ...
      description: 'В течение декабря будет проведен капитальный ремонт подъездов в домах №5-10 по улице Ленина. Просим отнестись с пониманием к временным неудобствам.',
      type: 'work'
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              © 2025 ООО «Бунарский район 1». Все права защищены.
            </p>
